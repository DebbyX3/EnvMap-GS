...
def PILtoTorch(pil_image, resolution):
    '''
    BEGIN NEW CUSTOM CODE
    THIS IS A FIX PROPOSED IN THIS PULL REQ:
    https://github.com/graphdeco-inria/gaussian-splatting/pull/1193
    
    Notes
    The render.py might need fixed to export the masked GT 
    (rather than the original RGB) when running on trained 
    model with original resolution settings (no - r).
    '''
